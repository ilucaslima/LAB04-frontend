  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-blue-600">
      <div className="bg-[#FFFFFF] p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-2xl text-[#191b29] font-bold mb-6 text-center color-">Bem-vindo de volta</h2>

       
        <div className="mb-4">
          <label className="block  text-[#414754]  font-semibold mb-1">Endereço de E-mail</label>
          <div className="flex items-center border rounded px-3 bg-[#F4F2FF]">
            ...
            <input
              ...
              className="w-full py-2 outline-none text-[#A5A8B6]"
            />
          </div>
        ...
        <div className="mb-4">
          <label className="block text-[#414754] font-semibold mb-1">Senha</label>
          <div className="flex items-center border rounded px-3 bg-[#F4F2FF]">
        ...
        <button
          onClick={handleLogin}
          className="w-full bg-blue-600 text-white py-2 rounded-lg flex items-center justify-center font-semibold hover:bg-blue-700"
        >    
        ...
        <div className="flex space-x-4">
          <button className="flex-1 text-[#191b29] font-bold border rounded py-2 bg-white shadow hover:bg-gray-100">
            Google
          </button>
          <button className="flex-1 text-[#191b29] border font-bold rounded py-2 bg-white shadow hover:bg-gray-100">
            GitHub
          </button>
        </div>

      
        <p className="mt-6 text-center text-[#414754]">
          Não tem uma conta?{" "}
